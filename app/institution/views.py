...
def add_get_institutions():
    if request.method == 'GET':        
        ...
        if form.validate():
            ...
            fax = data.get('fax')
            latitude = data.get('latitutde')
            longitude = data.get('longitude')
            wilaya = Wilya.query.get(data.get('wilaya_id'))
            institution_class = InstitutionClass.query.get('institution_class_id')
...
def modify_institution(id):
    ...
    if request.method == 'GET':
        ...
        if form.validate():
            ...
            institution.latitude = data.get('latitutde')
            institution.longitude = data.get('longitude')
            institution.wilaya = Wilya.query.get(data.get('wilaya_id'))
            institution.institution_class = InstitutionClass.query.get('institution_class_id')
